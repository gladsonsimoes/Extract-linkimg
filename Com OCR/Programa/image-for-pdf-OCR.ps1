...
$tesseract = "..\Arquives\Packages\Tesseract-OCR\tesseract.exe"

# Pasta onde estão as imagens
#$imagensPath = "..\Arquives\temporary_files\downloaded_images"
$imagensPath = ".\Files-Create\downloaded_images"

# Pasta de saída
$saidaPath = ".\Files-Create\pdfCreate"
...
$env:TESSDATA_PREFIX = (Resolve-Path "..\Arquives\Packages\Tesseract-OCR\tessdata").Path
