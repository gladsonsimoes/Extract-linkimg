...
$outputFile = "..\Arquives\temporary_files\links_extracted.txt" # Arquivo para salvar os links extraídos
$downloadFolder = ".\Files-Create\downloaded_images"  # Pasta para salvar as imagens baixadas
